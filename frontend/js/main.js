...
class AuthManager {
    ...
    static loadUserName() {
        ...
        // Update all elements with userName id
        const userNameElements = document.querySelectorAll('#userName');
        userNameElements.forEach(el => {
            el.textContent = userName;
        });
        
        // Update all elements with dropdownName id
        const dropdownNameElements = document.querySelectorAll('#dropdownName');
        dropdownNameElements.forEach(el => {
            el.textContent = userName;
        });
        
        // Update input fields with value="John Doe"
        const inputFields = document.querySelectorAll('input[value="John Doe"]');
        ...
        const dropdownEmailElements = document.querySelectorAll('#dropdownEmail');
        dropdownEmailElements.forEach(el => {
